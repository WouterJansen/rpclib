...
struct as<std::chrono::time_point<Clock, Duration>> {
    typename std::chrono::time_point<Clock, Duration> operator()(clmdep_msgpack::object const& o) const {
        if(o.type != clmdep_msgpack::type::EXT) { throw clmdep_msgpack::type_error(); }
        if(o.via.ext.type() != -1) { throw clmdep_msgpack::type_error(); }
...
struct convert<std::chrono::time_point<Clock, Duration>> {
    clmdep_msgpack::object const& operator()(clmdep_msgpack::object const& o, std::chrono::time_point<Clock, Duration>& v) const {
        if(o.type != clmdep_msgpack::type::EXT) { throw clmdep_msgpack::type_error(); }
        if(o.via.ext.type() != -1) { throw clmdep_msgpack::type_error(); }
        std::chrono::time_point<Clock, Duration> tp;
        switch(o.via.ext.size) {
...
struct pack<std::chrono::time_point<Clock, Duration>> {
    ...
    clmdep_msgpack::packer<Stream>& operator()(clmdep_msgpack::packer<Stream>& o, std::chrono::time_point<Clock, Duration> const& v) const {
...
struct object_with_zone<std::chrono::time_point<Clock, Duration>> {
    void operator()(clmdep_msgpack::object::with_zone& o, const std::chrono::time_point<Clock, Duration>& v) const {
        int64_t count = detail::integral_cast<int64_t>(v.time_since_epoch().count());
