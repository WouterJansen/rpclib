...
struct convert<timespec> {
    clmdep_msgpack::object const& operator()(clmdep_msgpack::object const& o, timespec& v) const {
...
struct pack<timespec> {
    ...
    clmdep_msgpack::packer<Stream>& operator()(clmdep_msgpack::packer<Stream>& o, const timespec& v) const {
...
struct object_with_zone<timespec> {
    void operator()(clmdep_msgpack::object::with_zone& o, const timespec& v) const {
        if ((static_cast<uint64_t>(v.tv_sec) >> 34) == 0) {
            uint64_t data64 = (static_cast<uint64_t>(v.tv_nsec) << 34) | static_cast<uint64_t>(v.tv_sec);
            if ((data64 & 0xffffffff00000000L) == 0) {
                // timestamp 32
